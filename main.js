...
board.on("ready", function() {
    ...
    var weatherStartDate = moment().now.hour(8).minute(0).second(0);
    var weatherEndDate = moment().now.hour(11).minute(0).second(0);

    var tvStartDate = moment().now.hour(16).minute(0).second(0);
    var tvEndDate = moment().now.hour(19).minute(30).second(0);
